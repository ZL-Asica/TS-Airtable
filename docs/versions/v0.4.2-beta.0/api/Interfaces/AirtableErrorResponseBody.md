...
Defined in: [types/errors.ts:17](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2-beta.0/types/errors.ts#L17)
...
Defined in: [types/errors.ts:24](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2-beta.0/types/errors.ts#L24)
