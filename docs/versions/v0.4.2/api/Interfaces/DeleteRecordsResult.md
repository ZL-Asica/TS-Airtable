...
Defined in: [types/records.ts:367](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2/types/records.ts#L367)
...
Defined in: [types/records.ts:373](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2/types/records.ts#L373)
