...
Defined in: [types/records.ts:448](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2/types/records.ts#L448)
...
Defined in: [types/records.ts:453](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2/types/records.ts#L453)
