...
Defined in: [types/records.ts:307](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2/types/records.ts#L307)
...
Defined in: [types/records.ts:314](https://github.com/ZL-Asica/TS-Airtable/blob/v0.4.2/types/records.ts#L314)
