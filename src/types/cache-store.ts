import type { AirtableAttachment } from './field-values'

/**
 * Context passed to {@link AirtableCacheStore.transformAttachment} describing
 ...
 */
export interface AirtableAttachmentCacheContext {
  /**
